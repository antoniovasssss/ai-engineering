...
input_tokens = response.usage.prompt_tokens # Extract the token usage
output_tokens = max_completion_tokens
print(response)


cost = (input_tokens * input_token_price + output_tokens * output_token_price) # Calculate the cost
